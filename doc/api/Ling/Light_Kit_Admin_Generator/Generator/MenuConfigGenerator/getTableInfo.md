...
Source Code
===========
See the source code for method [MenuConfigGenerator::getTableInfo](https://github.com/lingtalfi/Light_Kit_Admin_Generator/blob/master/Generator/MenuConfigGenerator.php#L134-L194)
